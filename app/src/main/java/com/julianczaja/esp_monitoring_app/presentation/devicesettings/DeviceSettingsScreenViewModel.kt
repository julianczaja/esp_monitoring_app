...
class DeviceSettingsScreenViewModel @Inject constructor(
    ...
    fun updateDeviceSettings() = viewModelScope.launch(Dispatchers.IO) {
        ...
        deviceSettingsRepository.getCurrentDeviceSettingsRemote(deviceArgs.deviceId) // TODO: Check if it's not in progress already
            .onFailure {
    ...
    private fun deviceSettingsStream() = deviceSettingsRepository.getDeviceSettingsLocal(deviceArgs.deviceId)
